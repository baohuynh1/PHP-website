		...
		add_action(
			...
			function () {
				...
				if (mktime(0, 0, 0, 11, 17, 2022) <= $current && $current <= mktime(0, 0, 0, 1, 15, 2023)) {
					if (get_option('rtrs_ny_2023') != '1') {
						if (! isset($GLOBALS['rtrs_ny_2023_notice'])) {
							$GLOBALS['rtrs_ny_2023_notice'] = 'rtrs_ny_2023';
							self::notice();
						}
					}
				}
	...
	public static function notice() {
		...
		add_action(
			...
			function () {
				...
				<div class="notice notice-info is-dismissible" data-rtrsdismissable="rtrs_ny_2023"
					...
					<p style="margin:0 0 2px;">
						...
						<b>Review Schema Pro plan</b> with <b>UP TO 50% OFF</b>! Limited time offer!!
					</p>
