...
if ( ! class_exists( 'GymEdge_Address_Widget' ) ){
	class GymEdge_Address_Widget extends WP_Widget {
		public function __construct() {
            ...
            __( 'GymEdge: Address', 'gymedge-core' ), // Name
            array( 'description' => __( 'GymEdge: Address Widget', 'gymedge-core' ) ) // Args
        );
		}
		...
		public function widget( $args, $instance ){
			...
			<ul>
				...
				if( !empty( $instance['address'] ) ){
					?><li><i class="fa fa-paper-plane" aria-hidden="true"></i> <?php echo wp_kses_post( $instance['address'] ); ?></li><?php
				}  
				...
				if( !empty( $instance['email'] ) ){
					?><li><i class="fa fa-envelope" aria-hidden="true"></i> <a href="mailto:<?php echo esc_attr( $instance['email'] ); ?>"><?php echo esc_html( $instance['email'] ); ?></a></li><?php
				}  
		...
		public function form( $instance ){
			$defaults = array(
				'title'   => __( 'Corporate Office' , 'gymedge-core' ),
				'address' => '',
				'phone'   => '',
				'email'   => '',
				'fax'     => ''  
			...
			$fields = array(
				...
				'address'   => array(
					'label' => __( 'Address', 'gymedge-core' ),
					'type'  => 'textarea',
				),
				'phone'     => array(
					'label' => __( 'Phone Number', 'gymedge-core' ),
					'type'  => 'text',
				),
				'email'     => array(
