...
if ( ! class_exists( 'GymEdge_About_Widget' ) ){
	class GymEdge_About_Widget extends WP_Widget {
		public function __construct() {
            ...
            __( 'GymEdge: About', 'gymedge-core' ), // Name
            array( 'description' => __( 'GymEdge: About Widget', 'gymedge-core' ) ) // Args
        );
		}
			...
			<div class="footer-social-media-area">
				<ul>
					...
					if( !empty( $instance['rss'] ) ){
						?><li><a href="<?php echo esc_url( $instance['rss'] ); ?>" target="_blank"><i class="fab fa-rss"></i></a></li><?php
					}
					?>
				</ul>
			</div> 
		...
		public function form( $instance ){
			$defaults = array(
				'title'          => __( 'About Company' , 'gymedge-core' ),
				'description'    => '',
				'facebook'       => '',
				'twitter'        => '',
				'gplus'          => '',
			...
			$fields = array(
				...
				'facebook'          => array(
					'label'    => __( 'Facebook URL', 'gymedge-core' ),
					'type'       => 'url',
				),
				'twitter'          => array(
					'label'    => __( 'Twitter URL', 'gymedge-core' ),
					'type'       => 'url',
				),
				'gplus'          => array(
					'label'    => __( 'Google Plus URL', 'gymedge-core' ),
					'type'       => 'url',
				),
				'linkedin'          => array(
					'label'    => __( 'Linkedin URL', 'gymedge-core' ),
					'type'       => 'url',
				),
				'pinterest'          => array(
					'label'    => __( 'Pinterest URL', 'gymedge-core' ),
					'type'       => 'url',
				),
				'instagram'          => array(
					'label'    => __( 'Instagram URL', 'gymedge-core' ),
					'type'       => 'url',
				),
				'youtube'          => array(
					'label'    => __( 'YouTube URL', 'gymedge-core' ),
					'type'       => 'url',
				),
				'rss'          => array(
					'label'    => __( 'Rss Feed URL', 'gymedge-core' ),
					'type'       => 'url',
				),
			);
