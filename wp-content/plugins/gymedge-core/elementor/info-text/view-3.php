...
?>
<div class="rt-info-text-3 rt-<?php echo esc_attr($data['content_align']); ?>">
    <div class="title<?php echo ( $data['image_style'] == 'rounded' ) ? ' rounded' : '' ; ?>">
    ...
    <div class="media-body">
        ...
        <?php if( !empty( $data['content'] ) ): ?>
            <p class="mb0"><?php echo wp_kses_post( $data['content'] ); ?></p>
        <?php endif; ?>
    </div>
    <div class="clear"></div>
</div>