...
class Class_Slider extends Custom_Widget_Base {

    public function __construct( $data = [], $args = null ) {
        $this->rt_name  = __( 'Class Slider', 'gymedge-core' );
        $this->rt_base  = 'rt-class-slider';
    ...
    public function rt_fields() {
        ...
        $fields = array(
            ...
            array(
                'type'        => Controls_Manager::SWITCHER,
                'id'          => 'slider_dot',
                'label'       => esc_html__( 'Slider Dot', 'gymedge-core' ),
                'label_on'    => esc_html__( 'On', 'gymedge-core' ),
                'label_off'   => esc_html__( 'Off', 'gymedge-core' ),
                'default'     => 'yes',
                'description' => esc_html__( 'Enable or disable autoplay. Default: Off', 'gymedge-core' ),
            ...
            array (
                ...
                'selector' => '{{WRAPPER}} .single-item-meta > h3 a',
            ),
            array (
                'mode'    => 'group',
                'type'    => Group_Control_Typography::get_type(),
                ...
                'selector' => '{{WRAPPER}} .rt-owl-class-1 .single-item .single-item-content .overly .class-slider-ul-child li',
                'condition' => array(
                    'style' => array( 'style1' ),
                ),
            ),
            array (
                ...
                'type'    => Group_Control_Typography::get_type(),
                'id'    => 'author_typo',
                'label'   => esc_html__( 'Author', 'gymedge-core' ),
                'selector' => '{{WRAPPER}} .single-item-meta .author',
            ),
            array(
                'mode'  => 'section_end'
            ),
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .single-item .single-item-meta' => 'background-color: {{VALUE}}',
                ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
                ...
                'selectors' => array(
                    '{{WRAPPER}} .single-item .single-item-meta > h3 a' => 'color: {{VALUE}}',
                ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
                'id'      => 'box_hover_bg',
                'label'   => __( 'Box Hover Background', 'gymedge-core' ),
                'selectors' => array(
                    '{{WRAPPER}} .single-item:hover .single-item-meta' => 'background-color: {{VALUE}}',
                ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
                ...
                'selectors' => array(
                    '{{WRAPPER}} .single-item:hover .single-item-meta > h3 a' => 'color: {{VALUE}}',
                ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rt-owl-class-1 .single-item .single-item-content .overly .class-slider-ul-child li:first-child' => 'background-color: {{VALUE}}'
                ),
                'condition' => array(
                    'style'    => array( 'style1' ),
                ),
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rt-owl-class-1 .single-item .single-item-content .overly .class-slider-ul-child li:first-child' => 'color: {{VALUE}}',
                ),
                'condition' => array(
                    'style'    => array( 'style1' ),
                ),
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rt-owl-class-1 .single-item .single-item-content .overly .class-slider-ul-child li:last-child' => 'background-color: {{VALUE}}'
                ),
                'condition' => array(
                    'style'    => array( 'style1' ),
                ),
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rt-owl-class-1 .single-item .single-item-content .overly .class-slider-ul-child li:last-child' => 'color: {{VALUE}}',
                ),
                'condition' => array(
                    'style'    => array( 'style1' ),
                ),
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rt-owl-class-1 .single-item .single-item-content::after' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .rt-owl-class-2 .single-item .single-item-content::after' => 'background-color: {{VALUE}}',
                ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
                'id'      => 'author_color',
                'label'   => __( 'Author Color', 'gymedge-core' ),
                'selectors' => array(
                    '{{WRAPPER}} .single-item .single-item-meta .author' => 'color: {{VALUE}}',
                ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
                'id'      => 'author_hover_color',
                'label'   => __( 'Author Hover Color', 'gymedge-core' ),
                'selectors' => array(
                    '{{WRAPPER}} .single-item:hover .single-item-meta .author' => 'color: {{VALUE}}',
                ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
                'id'      => 'author_icon_color',
                'label'   => __( 'Author Icon Color', 'gymedge-core' ),
                'selectors' => array(
                    '{{WRAPPER}} .single-item .single-item-meta .author .fa' => 'color: {{VALUE}}',
                ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
                'id'      => 'author_icon_hover_color',
                'label'   => __( 'Author Icon Hover Color', 'gymedge-core' ),
                'selectors' => array(
                    '{{WRAPPER}} .single-item:hover .single-item-meta .author .fa' => 'color: {{VALUE}}',
                ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rt-owl-class-2 .single-item .details a' => 'background-color: {{VALUE}}',
                ),
                'condition' => array(
                    'style'    => array( 'style2' ),
                ),
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rt-owl-class-2 .single-item .details a' => 'border-color: {{VALUE}}',
                ),
                'condition' => array(
                    'style'    => array( 'style2' ),
                ),
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rt-owl-class-2 .single-item .details a' => 'color: {{VALUE}}',
                ),
                'condition' => array(
                    'style'    => array( 'style2' ),
                ),
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rt-owl-class-2 .single-item .details a:hover' => 'background-color: {{VALUE}}',
                ),
                'condition' => array(
                    'style'    => array( 'style2' ),
                ),
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rt-owl-class-2 .single-item .details a:hover' => 'border-color: {{VALUE}}',
                ),
                'condition' => array(
                    'style'    => array( 'style2' ),
                ),
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rt-owl-class-2 .single-item .details a:hover' => 'color: {{VALUE}}',
                ),
                'condition' => array(
                    'style'    => array( 'style2' ),
                ),
