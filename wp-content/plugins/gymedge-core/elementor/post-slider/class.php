...
class Post_Slider extends Custom_Widget_Base {
    ...
    public function __construct( $data = [], $args = null ) {
        $this->rt_name  = __( 'Post Slider', 'gymedge-core' );
    ...
    public function rt_fields() {
        ...
        $fields = array(
            ...
            array(
                'id'        => 'item_no',
                'label'     => __( 'Total number of posts', 'gymedge-core' ),
            ...
            array (
                ...
                'selector' => '{{WRAPPER}} .rtin-post-title a',
            ),
            array (
                'mode'    => 'group',
                'type'    => Group_Control_Typography::get_type(),
                ...
                'selector' => '{{WRAPPER}} .rtin-post-content',
            ),
            array (
                'mode'    => 'group',
                'type'    => Group_Control_Typography::get_type(),
                ...
                'selector' => '{{WRAPPER}} .single-item .date',
            ),
            array(
                'mode' => 'section_end',
            ),
            ...
            array(
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rtin-post-title a' => 'color: {{VALUE}}',
                ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rtin-post-title a:hover' => 'color: {{VALUE}}',
                ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
                ...
                'selectors' => array(
                    '{{WRAPPER}} .rtin-post-content' => 'color: {{VALUE}}',
                ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
                ...
                'selectors' => array(
                    '{{WRAPPER}} .single-item .date' => 'background-color: {{VALUE}}',
                ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
                ...
                'selectors' => array(
                    '{{WRAPPER}} .single-item .date' => 'color: {{VALUE}}',
                ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
            ...
            array(
                'type'    => Controls_Manager::COLOR,
                'id'      => 'link_icon_color',
                'label'   => __( 'Link Icon Color', 'gymedge-core' ),
                'selectors' => array(
                    '{{WRAPPER}} .rt-owl-post-2 .single-item .details a' => 'color: {{VALUE}}',
                ),
                'condition'   => array( 'style' => 'style2' ),
            ),
            array(
                'type'    => Controls_Manager::COLOR,
                'id'      => 'link_icon_border_color',
                'label'   => __( 'Link Icon Border Color', 'gymedge-core' ),
                'selectors' => array(
                    '{{WRAPPER}} .rt-owl-post-2 .single-item .details a' => 'border-color: {{VALUE}}',
                ),
                'condition'   => array( 'style' => 'style2' ),
            ),
            array(
