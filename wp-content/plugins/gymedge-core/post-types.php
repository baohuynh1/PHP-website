...
$gym_taxonomies = array(
	'gym_team_category'       => array(
		...
		'rewrite'      => array( 'slug' => GymEdge::$options['trainer_cat_slug'] ),
	),
	'gym_class_category'       => array(
		...
		'rewrite'      => array( 'slug' => GymEdge::$options['class_cat_slug'] ),
	),
...
$gym_post_types = apply_filters( 'gymedge_post_types', $gym_post_types );
$gym_taxonomies = apply_filters( 'gymedge_taxonomies', $gym_taxonomies );
