	...
	'fields' => array(
		...
		'gym_header' => array(
			...
			'options' => array(
				...
				'st3'     => __( 'Style 3', 'gymedge-core' ), // trheader on
			),
			'default'  => 'default',
		),
		'gym_preloader' => array(
			'label' => __( 'Preloader', 'gymedge-core' ),
			'type'  => 'select',
			'options' => array(
				'default' => __( 'Default', 'gymedge-core' ),
				'on'      => __( 'Enabled', 'gymedge-core' ),
...
$GymEdge_Postmeta->add_meta_box( 'trainer_info', __( 'Trainer Info', 'gymedge-core' ), array( 'gym_trainer' ), '', '', 'high', array(
	'fields' => array(
		...
		'gym_trainer_education' => array(
			'label' => __( 'Education', 'gymedge-core' ),
			'type'  => 'text',
		),
...
$GymEdge_Postmeta->add_meta_box( 'class_schedule', __( 'Schedule', 'gymedge-core' ), array( 'gym_class' ), '', '', 'high', array(
	'fields' => array(
		'gym_class_color' => array(
			'label' => __( 'Color', 'gymedge-core' ),
			'type'  => 'color_picker',
			'desc'  => __( 'Only Used in Routine Style 2', 'gymedge-core' ),
		),
