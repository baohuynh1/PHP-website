<?php
class GymEdge_VC_Trainer extends RDTheme_VC_Modules {

	public function __construct(){
		$this->name = __( "GymEdge: Trainer", 'gymedge-core' );
		$this->base = 'gymedge-vc-trainer';
		$this->translate = array(
			'title' => __( "EXPERT TRAINERS", 'gymedge-core' ),
			'cols'  => array( 
		...
		$fields = array(
			...
			array(
				...
				"value" => array( 
					...
					__( "Style 4", 'gymedge-core' ) => 'style4',
					),
				'dependency' => array(
					'element' => 'layout',
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => __( "Content Limit", 'gymedge-core' ),
				...
				"value" => '20',
				"description" => __( "Maximum number of words to display. Default: 20", 'gymedge-core' ),
				),
			array(
				"type" => "dropdown",
				"holder" => "div",
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => __( "Select Trainer", 'gymedge-core' ),
				"param_name" => "item",
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => __( "Designation display", 'gymedge-core' ),
				"param_name" => "designation_display",
				"value" => array( 
					__( "Enabled", 'gymedge-core' )  => 'true',
					__( "Disabled", 'gymedge-core' ) => 'false',
				),
				"description" => __( "Show or hide trainer designation. Default: Enabled", 'gymedge-core' ),
			),
			array(
				"type" => "dropdown",
				"holder" => "div",
				"class" => "",
				"heading" => __( "Description display", 'gymedge-core' ),
				"param_name" => "description_display",
				"value" => array( 
					__( "Enabled", 'gymedge-core' )  => 'true',
					__( "Disabled", 'gymedge-core' ) => 'false',
				),
				"description" => __( "Show or hide trainer description. Default: Enabled", 'gymedge-core' ),
			),
			array(
				"type" => "dropdown",
				"holder" => "div",
				"class" => "",
				"heading" => __( "Skill display", 'gymedge-core' ),
				"param_name" => "skill_display",
				"value" => array( 
					__( "Enabled", 'gymedge-core' )  => 'true',
					__( "Disabled", 'gymedge-core' ) => 'false',
				),
				...
				"description" => __( "Show or hide trainer skills. Default: Enabled", 'gymedge-core' ),
			),
			array(
				"type" => "dropdown",
				"holder" => "div",
				"class" => "",
				"heading" => __( "Information display", 'gymedge-core' ),
				"param_name" => "info_display",
				"value" => array( 
					__( "Enabled", 'gymedge-core' )  => 'true',
					__( "Disabled", 'gymedge-core' ) => 'false',
				),
				...
				"description" => __( "Show or hide trainer information. Default: Enabled", 'gymedge-core' ),
			),
			array(
				"type" => "dropdown",
				"holder" => "div",
				"class" => "",
				"heading" => __( "Social Links display", 'gymedge-core' ),
				"param_name" => "social_display",
				"value" => array( 
					__( "Enabled", 'gymedge-core' )  => 'true',
					__( "Disabled", 'gymedge-core' ) => 'false',
				),
				...
				"description" => __( "Show or hide trainer social links. Default: Enabled", 'gymedge-core' ),
			),
			// Responsive Columns
			array(
				"type" => "dropdown",
	...
	public function shortcode( $atts, $content = '' ){
		...
		$description_display   = $description_display == 'true' ? true : false;
		$skill_display         = $skill_display == 'true' ? true : false;
		$info_display          = $info_display == 'true' ? true : false;
		$social_display        = $social_display == 'true' ? true : false;
		...
		switch ( $layout ) {
			...
			switch ( $slider_style ) {
				...
				break;
				case 'style4':
				$template = 'trainer-grid-4';
				break;
				default:
				$template = 'trainer-grid';
				break;
			}
			break;
			...
			switch ( $slider_style ) {
				case 'style2':
				$template = 'trainer-slider-2';
				break;
				case 'style3':
				$template = 'trainer-slider-3';
				break;
				case 'style4':
				$template = 'trainer-slider-4';
				break;
				default:
				$owl_data['nav'] = false;
				$template = 'trainer-slider-1';
				break;
			}
			$this->load_scripts();
			break;
